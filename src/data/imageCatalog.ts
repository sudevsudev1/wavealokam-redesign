...
export const surfingImages: CatalogImage[] = [
  ...
  { path: '/activities/surfing-new/a04.webp', title: 'Annie showing age is just a number', alt: 'Annie proving age is just a number on the waves at Varkala', tags: ['surfing', 'age', 'inspiration', 'annie'] },
  ...
  { path: '/activities/surfing-new/a01.webp', title: 'Probably the only sport where failing is just as much fun as succeeding. Annie will attest.', alt: 'Surfer wiping out and laughing — the only sport where failing is just as fun as succeeding. Annie will attest.', tags: ['surfing', 'fun', 'wipeout', 'laughing', 'annie'] },
  ...
  { path: '/activities/surfing/2.jpg', title: 'As expected, Annie defying all odds - standing up in the first session at 65 years of age', alt: 'Annie standing up on surfboard in her very first session at 65 years of age at Wavealokam', tags: ['surfing', 'age', 'inspiration', 'first-time', '65', 'annie'] },
...
export const legendsImages: CatalogImage[] = [
  ...
  { path: '/gallery/legends/legends04.webp', title: 'Joanna with Anandhu - debate still unsettled who asked for a selfie first', alt: 'Joanna posing with Anandhu — debate still unsettled who asked for a selfie first, but Anandhu\'s exceptional promptness is not in question', tags: ['legends', 'guests', 'anandhu', 'staff', 'selfie', 'joanna'] },
  { path: '/gallery/legends/legends05.webp', title: 'Joanna loved the food so much she wanted to learn to cook it', alt: 'Wavealokam guest Joanna so impressed by the food she asked to learn how to cook it', tags: ['legends', 'guests', 'food', 'cooking', 'joanna'] },
