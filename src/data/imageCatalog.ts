...
export const surfingImages: CatalogImage[] = [
  ...
  { path: '/activities/surfing-new/a03.webp', title: 'Age is just a number', alt: 'Older surfer proving age is just a number on the waves at Varkala', tags: ['surfing', 'age', 'inspiration'] },
  { path: '/activities/surfing-new/a06.webp', title: 'Proud mommy and baby watching daddy try something new and exciting', alt: 'Mother and baby watching from the beach as daddy takes on surfing for the first time', tags: ['surfing', 'family', 'spectators', 'baby'] },
  { path: '/activities/surfing-new/a07.webp', title: 'Family photo after a life-changing spirit-opening surf session', alt: 'Family group photo on the beach after their first transformative surfing session at Wavealokam', tags: ['surfing', 'family', 'group', 'life-changing'] },
  { path: '/activities/surfing-new/a08.webp', title: 'Surfing gives you wings', alt: 'Surfer catching air on a wave at Varkala — surfing gives you wings', tags: ['surfing', 'action', 'air', 'wings'] },
  { path: '/activities/surfing-new/a02.webp', title: 'You have to learn to fall before you fly', alt: 'Surfer falling off the board — learning to fall before you fly at Varkala', tags: ['surfing', 'falling', 'learning', 'beginner'] },
  { path: '/activities/surfing-new/a10.webp', title: 'Theory lessons are mandatory — like the calm before the storm', alt: 'Surf instructor giving mandatory theory lessons on the beach before heading into the water', tags: ['surfing', 'theory', 'lessons', 'instructor', 'beach'] },
  { path: '/activities/surfing-new/a11.webp', title: 'To tell you the truth it\'s not surfing — it\'s flying', alt: 'Surfer gliding on a wave at Varkala — it\'s not surfing, it\'s flying', tags: ['surfing', 'flying', 'action', 'wave'] },
  { path: '/activities/surfing-new/a01.webp', title: 'C\'mon let\'s get into the water already', alt: 'Eager surfers ready to get into the water at Varkala beach', tags: ['surfing', 'excitement', 'beach', 'eager'] },
  { path: '/activities/surfing-new/2.webp', title: 'Probably the only sport where failing is just as much fun as succeeding', alt: 'Surfer wiping out and laughing — the only sport where failing is just as fun as succeeding', tags: ['surfing', 'fun', 'wipeout', 'laughing'] },
  { path: '/activities/surfing-new/3.webp', title: 'Sudev Nair flexing out of habit', alt: 'Sudev Nair flexing on the beach out of habit at Varkala', tags: ['surfing', 'sudev', 'flexing', 'beach'] },
  { path: '/activities/surfing-new/4.webp', title: 'Sudev Nair during his initial surf days — needed his arm for direction, now he just thinks and the board follows', alt: 'Sudev Nair during early surf days using his arm for direction on the waves', tags: ['surfing', 'sudev', 'progress', 'early-days'] },
  { path: '/activities/surfing-new/5.webp', title: 'Sudev Nair only takes his shirt off when he has dieted for 4 weeks or more', alt: 'Sudev Nair shirtless surfing after a strict 4-week diet', tags: ['surfing', 'sudev', 'shirtless', 'humour', 'diet'] },
  { path: '/activities/surfing-new/6.webp', title: 'Sudev Nair with his ripped back from all that paddling', alt: 'Sudev Nair showing off his ripped back muscles earned from all that paddling', tags: ['surfing', 'sudev', 'fitness', 'paddling'] },
  { path: '/activities/surfing-new/7.webp', title: 'Sudev Nair instructing the photographer to take a picture from top angle', alt: 'Sudev Nair on the surfboard directing the photographer to shoot from above', tags: ['surfing', 'sudev', 'photography', 'humour'] },
  { path: '/activities/surfing-new/8.webp', title: 'Sudev Nair during his initial surf days when foam boards were his thing', alt: 'Sudev Nair riding a foam board during his early surfing days at Varkala', tags: ['surfing', 'sudev', 'foam-board', 'early-days'] },
  { path: '/activities/surfing-new/9.webp', title: 'Sudev and Amardeep playing with Nero and Ishtu after surfing', alt: 'Sudev and Amardeep Nair playing with dogs Nero and Ishtu on the beach after a surf session', tags: ['surfing', 'sudev', 'amardeep', 'dogs', 'nero', 'ishtu', 'beach'] },
  { path: '/activities/surfing-new/10.webp', title: 'Sudev Nair just a few days after switching to hard board', alt: 'Sudev Nair riding a hard board just days after making the switch from foam', tags: ['surfing', 'sudev', 'hard-board', 'progress'] },
  { path: '/activities/surfing/1.jpg', title: 'Sudev Nair showing off balancing skills mid-ocean with sunglasses', alt: 'Sudev Nair balancing on surfboard in the middle of the ocean wearing sunglasses', tags: ['surfing', 'sudev', 'balance', 'sunglasses', 'ocean'] },
  { path: '/activities/surfing/2.jpg', title: 'Surf brothers strike again', alt: 'The surf brothers back on the waves together at Varkala', tags: ['surfing', 'brothers', 'duo', 'action'] },
  { path: '/activities/surfing/3.jpg', title: 'Defying all odds — standing up in the first session at 65 years of age', alt: '65-year-old guest standing up on surfboard in their very first session at Wavealokam', tags: ['surfing', 'age', 'inspiration', 'first-time', '65'] },
  { path: '/activities/surfing/4.jpg', title: 'Falling into a wave is better than falling into rocks', alt: 'Surfer falling into a wave at Varkala — better than falling into rocks', tags: ['surfing', 'falling', 'wave', 'humour'] },
  { path: '/activities/surfing/5.jpg', title: 'Kids love surfing the most — they balance easily and have a short height to fall from', alt: 'Children surfing at Varkala — they balance easily and have a very short height to fall from', tags: ['surfing', 'kids', 'children', 'balance', 'fun'] },
  { path: '/activities/surfing/6.jpg', title: 'That look when you thought you had it but actually the ocean had you', alt: 'Surfer\'s expression when they thought they had the wave but the ocean had other plans', tags: ['surfing', 'humour', 'wipeout', 'expression'] },
  { path: '/activities/surfing/7.jpg', title: 'Nothing like an exciting surf session for father and daughter bonding', alt: 'Father and daughter bonding over an exciting surf session at Varkala', tags: ['surfing', 'family', 'father', 'daughter', 'bonding'] },
];
