...
const SurfStay = () => {
  const packages = [{
    ...
    duration: '1500 INR per session. 3-5 days recommended. 10% discount on pre paying for 5 sessions.'
  }, {
    ...
    duration: '2000 INR per session. 5-7 days recommended. 10% discount on prepaying for 5 sessions and 15% for 7.'
  }];
  const typicalDay = [{
    time: '6:30 AM',
