...
const SurfStay = () => {
  ...
  const typicalDay = [
    { time: '6:30 AM', activity: 'Wake up to ocean sounds' },
    { time: '7:00 AM', activity: 'Light breakfast & coffee' },
    { time: '7:30 AM', activity: 'Morning surf session (best waves)' },
    { time: '10:00 AM', activity: 'Big Kerala breakfast' },
    { time: '11:00 AM', activity: 'Rest, read, or explore' },
    { time: '4:00 PM', activity: 'Afternoon session or beach time' },
    { time: '6:30 PM', activity: 'Sunset from the terrace' },
    { time: '8:00 PM', activity: 'Dinner at local spots or rooftop' },
  ];

  const whatToBring = [
    'Swimwear (we provide rashguards)',
    'Sunscreen (reef-safe preferred)',
    'Flip-flops',
    'Light clothes for warm weather',
    'Enthusiasm for falling repeatedly',
  ];

  const weProvide = [
    'Surfboards (soft-tops for beginners)',
    'Leashes & rashguards',
  ...
  const internalLinks = [
    { name: 'Stay Only', href: '/stay', description: 'Just need a room?' },
    { name: 'Long Stay', href: '/long-stay', description: 'Surf for weeks, not days' },
  ...
  return (
    <>
      ...
      <main className="pt-16">
        <PillarHero
          title="Surf + Stay Packages at Wavealokam"
          subtitle="Wake up, surf, eat, repeat. The Kerala surf holiday you didn't know you needed."
        />
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="text-center p-6 bg-muted/20 rounded-2xl">
                ...
                <p className="text-muted-foreground">Max 4 students per instructor. More attention, faster progress.</p>
              </div>
            </div>
          </div>
        </section>
